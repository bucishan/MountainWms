...
namespace M.Utils.Json
{
    ...
    public static class Newtonsoft
    {
        ...
        public static string ToJsonLongString(this object obj)
        {
            return JsonConvert.SerializeObject(obj, new NumberConverter());
        }
    ...
    public sealed class NumberConverter : JsonConverter
    {
        ...
        {
            var typecode = Type.GetTypeCode(objectType.Name.Equals("Nullable`1") ? objectType.GetGenericArguments()[0] : objectType);
            switch (typecode)
            {
