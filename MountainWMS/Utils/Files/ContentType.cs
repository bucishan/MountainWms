...
namespace M.Utils.Files
{
    ...
    {
        public const string ContentTypeFile = "application/octet-stream";
        public const string ContentTypeExcel = "application/ms-excel";
        public const string ContentTypeJson = "application/json";
        public const string ContentTypeFrom = "application/x-www-form-urlencoded";
        public const string ContentTypeXml = "text/xml";
        public const string ContentTypeXml2 = "application/xml";
        public const string ContentTypeHtml = "text/html";
        public const string ContentTypeCss = "text/css";
        public const string ContentTypePpt = "application/x-ppt";
        public const string ContentTypeApk = "application/vnd.android.package-archive";
        public const string ContentTypeIpa = "application/vnd.iphone";
        public const string ContentTypeImg = "image/svg+xml";
        public const string ContentTypeSSE = "text/event-stream";//Server-Sent Events
        public const string CacheControl = "no-cache";
        public const string Connection = "keep-alive";

        public static IDictionary<string, string> GetContentTypes
        {
            get
            {
