...
using SqlSugar;
using System.Text;
using M.Core.Orm.SqlSugar;
using M.NetCore.Attributes;
using M.NetCore.Conventions;
using M.NetCore.DI;
using M.NetCoreApp.Extensions;
using M.Utils.Json;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddMvc(option =>
            {
                ...
                option.Conventions.Add(new ApplicationDescription("softname", Configuration["sys:softname"]));
                option.Conventions.Add(new ApplicationDescription("softtype", Configuration["sys:softtype"]));
                ...
                option.Conventions.Add(new ApplicationDescription("companylink", Configuration["sys:companylink"]));
                option.Conventions.Add(new ApplicationDescription("serviceline", Configuration["sys:serviceline"]));
