                ...
                var claims = new List<Claim>
                  {
                      ...
                      new Claim(ClaimTypes.Uri,string.IsNullOrWhiteSpace(item.Item3.HeadImg)?Path.Combine("upload","head","default_head.png"):item.Item3.HeadImg)
                  };
